<template>
    <div v-if="book" class="container p-5 mb-5">
                ...
                <table class="table table-bordered mt-3">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td v-for="kategori in book.kategori" :key="kategori.id" class="">
                                {{ kategori.kategori }}
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bold text-dark">Bahasa</td>
                            <td class="">{{ book.bahasa }}</td>
                        </tr>
                        <tr>
                            <td class="fw-bold text-dark">Status Buku</td>
                            <td>
                                <span
        ...
        <div class="mb-4">
            <h4 class="fw-semibold text-dark mb-1">Deskripsi</h4>
...
export default {
    ...
    methods: {
        ...
        async submitReview() {
            ...
            try {
                const response = await fetch(`https://e-library.up.railway.app/api/Buku/UlasanBuku`, {
                    method: 'POST',
                    headers: {
