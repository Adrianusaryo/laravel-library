<template>
    <div v-if="event" class="container bg-dark mt-5">
                ...
                <table class="table table-bordered mt-2 px-2">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-muted">{{ formatTanggal(event.tanggal) }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-muted">{{ event.narasumber }}</td>
                        </tr>
                        <tr>
                            <td class="fw-medium text-dark">
                        ...
                        <tr>
                            ...
                            <td class="text-muted">{{ event.alamat }}</td>
                        </tr>
                    </tbody>
                </table>
