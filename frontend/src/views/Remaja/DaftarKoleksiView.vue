...
export default {
    ...
    methods: {
        loadBuku(page = 1) {
            ...
            axios
                .get(
                    `https://e-library.up.railway.app/api/Buku/KoleksiBuku?usia=remaja&page=${page}&per_page=${this.perPage}${kategoriParam}`,
                    {
                        headers: {
        ...
        loadKategori() {
            axios
                ...
                .then((responseKategori) => {
                    ...
                    axios
                        .get(
                            `https://e-library.up.railway.app/api/Buku/KoleksiBuku?usia=remaja&per_page=${this.perPage}`,
                            {
                                headers: { Authorization: `Bearer ${this.token}` },
                            },
                        )
        ...
        searchBooks() {
            ...
            axios
                .get(
                    `https://e-library.up.railway.app/api/Buku/KoleksiBuku?usia=dewasa&per_page=1000`,
                    {
                        headers: { Authorization: `Bearer ${this.token}` },
                    },
                )
