<template>
    <div class="d-flex">
        ...
        <div class="flex-grow-1 px-4">
            <div class="container">
                <h5 class="fw-bold mt-4" style="line-height: 10px">Acara</h5>
...
export default {
    ...
    methods: {
        loadEvents(page = 1) {
            ...
            axios
                .get(
                    `https://laravel-library-production.up.railway.app/api/Acara/ListAcara?page=${page}&per_page=${this.perPage}&usia=dewasa`,
                    {
