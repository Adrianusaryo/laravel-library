<template>
    <div class="d-flex">
        ...
        <div class="flex-grow-1 px-4">
            <div class="container">
                <h5 class="fw-bold mt-4" style="line-height: 10px">Aktivitas</h5>
                ...
                <div v-show="!isLoading">
                    ...
                    <div v-if="peminjamanAktif.length > 0">
                        <div
                            ...
                            :key="'active-' + index"
                            class="card border-0 bg-body-tertiary shadow-sm mb-3"
                    ...
                    <div v-if="peminjamanSelesai.length > 0">
                        <div
                            ...
                            :key="'selesai-' + index"
                            class="card border-0 shadow-sm mb-5 bg-body-tertiary"
                            style="border-radius: 14px"
                        >
                            <div class="p-4">
                                <div class="d-flex justify-content-between align-items-center mb-1">
...
export default {
    ...
    mounted() {
        ...
        axios
            .get('https://laravel-library-production.up.railway.app/api/Peminjaman/LihatPeminjamanBuku', {
