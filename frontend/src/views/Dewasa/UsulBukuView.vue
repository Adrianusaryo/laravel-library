    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 px-4">
            <div class="container">
                ...
                <div
                    v-if="showForm"
                    class="card border-0 bg-body-tertiary shadow-sm mb-4 p-4"
                    style="border-radius: 14px"
                >
                    <h5 class="fw-bold mb-3">Form Usulan Buku</h5>
                    ...
                    <button class="btn btn-dark" @click="usulBuku">Kirim Usulan</button>
                ...
                <div v-else-if="UsulBuku.length > 0">
                    <div
                        ...
                        :key="'usul-' + index"
                        class="card border-0 shadow-sm mb-4 bg-body-tertiary"
                        style="border-radius: 14px"
                    >
                        <div class="p-4">
