                                ...
                                <div class="card-body py-3 px-4">
                                    ...
                                    <ul class="list-unstyled text-muted small mb-0">
                                        <li class="mb-2 d-flex align-items-start">
                                            <i class="fa fa-hat-wizard text-dark me-2 mt-1"></i>
                                        ...
                                        <li class="mb-2 d-flex align-items-start">
                                            <i class="fa fa-clock me-2 mt-1 text-dark"></i>
                                            <span
                                        ...
                                        <li class="d-flex align-items-start">
                                            <i class="fa fa-tree-city me-2 mt-1 text-dark"></i>
                ...
                .then((response) => {
                    ...
                    allBooks = allBooks.filter((book) => {
                        return book.kategori.some((kategori) => {
                            return kategori.usia.some((u) => u.nama.toLowerCase() === 'anak-anak')
                        })
                    })
                    this.books = allBooks
                })
